...
appModule.config([
    ...
    function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider.state('projectManagement', {
            'abstract': true,
            url: '/project',
            template: '<div ui-view class="fade-in-up"></div>'
        });

        if (abp.auth.hasPermission('Pages.TaskTracker.Manager')) {
            $stateProvider.state('projectManagement.manager', {
                url: '/manager',
                templateUrl: '~/App/projectmanagement/views/manager/project/index.cshtml',
                menu: 'ProjectManagement.Manager'
            });
        }

        if (abp.auth.hasPermission('Pages.TaskTracker.Agent')) {
            $stateProvider.state('projectManagement.agent', {
                url: '/agent',
                templateUrl: '~/App/projectmanagement/views/agent/index.cshtml',
                menu: 'ProjectManagement.Agent'
            });
        }
    }
]);
...
// custom
appModule.filter("IsItemInArray", ['$filter', function ($filter) {
