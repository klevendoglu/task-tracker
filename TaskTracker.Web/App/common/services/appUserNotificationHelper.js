(function () {
    appModule.factory('appUserNotificationHelper', [
            ...
            function ($uibModal, $location, notificationService) {
                ...
                /* Example:
                abp.notifications.messageFormatters['TaskTracker.MyNotificationDataType'] = function(userNotification) {
                ...
                */
                ...
                function getUrl(userNotification) {
                    switch (userNotification.notification.notificationName) {
                        ...
                        case 'App.NewTaskAssigned':
                            return '#/notifications?filterText=' + userNotification.notification.data.properties.filterText;
                        case 'App.NewTaskClosed':
                            return '#/notifications?filterText=' + userNotification.notification.data.properties.filterText;
