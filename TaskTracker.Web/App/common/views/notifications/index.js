(function () {
    appModule.controller('common.views.notifications.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'appUserNotificationHelper', 'abp.services.app.notification',
        function ($scope, $uibModal, $stateParams, uiGridConstants, appUserNotificationHelper, notificationService) {
            var vm = this;
