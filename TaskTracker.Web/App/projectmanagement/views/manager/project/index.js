(function () {
    appModule.controller('projectmanagement.views.manager.project.index', [
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        cellTemplate:
                           ...
                           '  <button ng-click="grid.appScope.View(row.entity)" class="btn btn-xs btn-primary gold" aria-expanded="false"><i class="fa fa-commenting-o"></i>' + app.localize('Details') + ' </button>' +
                           '  <button ng-click="grid.appScope.Delete(row.entity)" ng-if="row.entity.creatorUserId==' + userId + ' || ' + vm.isAdminAccount +'" class="btn btn-xs btn-primary red" aria-expanded="false"><i class="fa fa-trash-o"></i>' + app.localize('Delete') + ' </button>' +
                           '</div>'
                    },
                ],
                onRegisterApi: function (gridApi) {
                    $scope.adminUserId = app.consts.userManagement.defaultAdminUserId;
