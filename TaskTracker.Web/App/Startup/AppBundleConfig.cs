...
using TaskTracker.Web.Bundling;
            ...
            bundles.Add(
                new ScriptBundle("~/Bundles/App/libs/js")
                    .Include(
                        ...
                        // custom
                        ScriptPaths.Angular_ng_File_Upload,
                        ScriptPaths.Angular_DateTimePicker,
                        ScriptPaths.Angular_DateTimePicker_Templates,
                        ScriptPaths.Angular_DateTimeInput,
                        ScriptPaths.Angular_ui_select,
                        ScriptPaths.Angular_Filter
                    ).ForceOrdered()
                );
        ...
        private static void AddAppCssLibs(BundleCollection bundles, bool isRTL)
        {
            bundles.Add(
                new StyleBundle("~/Bundles/App/libs/css" + (isRTL ? "RTL" : ""))
                    ...
                    // custom
                    .Include(StylePaths.Angular_ui_select, new CssRewriteUrlTransform())
                    .Include(StylePaths.Angular_DateTimePicker)
