...
namespace TaskTracker.Web.Bundling
{
    public static class ScriptPaths
    {
        ...
        // Custom
        public const string Angular_ng_File_Upload = "~/libs/angular-file-upload/ng-file-upload.min.js";
        public const string Angular_DateTimePicker = "~/libs/angular-datetimepicker/datetimepicker.js";
        public const string Angular_DateTimePicker_Templates = "~/libs/angular-datetimepicker/datetimepicker.templates.js";
        public const string Angular_DateTimeInput = "~/libs/angular-datetimepicker/dateTimeInput.js";
        public const string Angular_ui_select = "~/metronic/assets/global/plugins/angularjs/plugins/ui-select/select.min.js";
        public const string Angular_Filter = "~/libs/angular-filter/angular-filter.min.js";
