...
namespace TaskTracker.Tests.Authorization.Users
{
    public class UserAppService_PermissionEdit_Tests : UserAppServiceTestBase
    {
        ...
        public async Task Should_Get_User_Permissions()
        {
            ...
            //Act
            var output = await UserAppService.GetUserPermissionsForEdit(new IdInput<long>(admin.Id));
        ...
        public async Task Should_Reset_Permissions()
        {
            ...
            //Act
            await UserAppService.ResetUserSpecificPermissions(new IdInput<long>(admin.Id));
