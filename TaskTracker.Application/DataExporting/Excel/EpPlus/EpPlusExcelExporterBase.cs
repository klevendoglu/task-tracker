...
using TaskTracker.Net.MimeTypes;
using OfficeOpenXml;

namespace TaskTracker.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TaskTrackerServiceBase, ITransientDependency
    {
