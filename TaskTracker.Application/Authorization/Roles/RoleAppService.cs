...
namespace TaskTracker.Authorization.Roles
{
    /// <summary>
    ...
    [DisableAuditing]
    public class RoleAppService : TaskTrackerAppServiceBase, IRoleAppService
    {
        ...
        {
            var permissions = PermissionManager.GetAllPermissions().Where(x=> x.Name != AppPermissions.Pages_Superadministration);
